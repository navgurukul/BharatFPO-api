...
const maxFileSize = process.env.MAX_FILE_SIZE ? process.env.MAX_FILE_SIZE * 1024 : 10240 * 1024; //10MB
const fileConfig = {
...
async function generateSignedUrl(data, _cb) {
    return new Promise((resolve, reject) => {
        ...
        var file_alias = custom
            ? process.env.TARGET_FOLDER + fileNameWithoutExt + "_" + date + file_extension
            : process.env.TARGET_FOLDER + fileNameWithoutExt + "_" + uuid.v4() + file_extension;
